        ...
        <form method="POST" action="/register">
            ...
            <div class="mb-4">
                <input type="text" name="country" placeholder="Country"
                    class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $user['country'] ?? '' ?>" />
            </div>
            <div class="mb-4">
                <input type="password" name="password" placeholder="Password"
                    class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $user['password'] ?? '' ?>" />
            </div>
            <div class="mb-4">
